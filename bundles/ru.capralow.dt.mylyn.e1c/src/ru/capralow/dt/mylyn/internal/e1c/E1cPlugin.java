 ...
 *
 */
public class E1cPlugin
    extends Plugin
{
    public static final String ID = "ru.capralow.dt.mylyn.e1c"; //$NON-NLS-1$

    private static E1cPlugin instance;
    ...
    public static E1cPlugin getInstance()
    {
        return instance;
    }
